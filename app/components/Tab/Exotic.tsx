const Exotic = () => {
  const posts = [
    ...
    },
    {
      ...
      img: 'https://images.unsplash.com/photo-1556155092-490a1ba16284?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80',
      authorLogo: 'https://api.uifaces.co/our-content/donated/xZ4wg2Xj.jpg',
      HouseName: 'Tropical Rainforest Retreat',
      date: 'Jan 4 2022',
      href: 'javascript:void(0)'
    },
    {
      ...
      img: 'https://images.unsplash.com/photo-1556155092-490a1ba16284?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80',
      authorLogo: 'https://api.uifaces.co/our-content/donated/xZ4wg2Xj.jpg',
      HouseName: 'Paradise Cove Bungalow',
      date: 'Jan 4 2022',
      href: 'javascript:void(0)'
    }
  ]
  ...
  return (
    <section className='mt-12 mx-auto px-4 max-w-screen-xl md:px-8'>
      <div className='text-center'>
        <h1 className='text-3xl text-gray-800 font-semibold'>Exotic Escapes</h1>
        <p className='mt-3 text-gray-500'>
          Discover luxurious retreats in stunning destinations around the world.{' '}
        </p>
      </div>
