  ...
  return (
    <section className='mt-12 mx-auto px-4 max-w-screen-xl md:px-8'>
      <div className='text-center'>
        <h1 className='text-3xl text-gray-800 font-semibold'>POPULAR PLACES</h1>
            ...
            <a href={items.href}>
              ...
              <div className='flex justify-between items-center mt-2 pt-3 mx-4'>
                <div className='flex-start mr-3'>
                  <span className='block text-gray-900'>{items.HouseName}</span>
                </div>
